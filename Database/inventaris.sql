...
(1, 'Mouse', 15, 'Baik', 2),
(2, 'Kyboard', 10, 'Baik', NULL),
(3, 'Stop Kontak', 5, 'Baik', NULL),
(6, 'Chip', 5, 'Baik', 2);
...
INSERT INTO `transaksi` (`id_transaksi`, `id_barang`, `id_petugas`, `tanggal`, `jenis_transaksi`, `jumlah`, `keterangan`) VALUES
(6, 1, NULL, '2026-04-05', 'Masuk', 1, 'Pembelajaran'),
(8, 2, NULL, '2026-04-06', 'Keluar', 1, 'Pembelajaran'),
(9, 3, NULL, '2026-04-08', 'Masuk', 1, 'praktikum');
